...
COCO_TRAIN_EXAMPLES = 4688
COCO_VAL_EXAMPLES = 860
      ...
      task=maskrcnn.MaskRCNNTask(
          ...
          model=maskrcnn.MaskRCNN(
              ...
              norm_activation=common.NormActivation(
                  use_sync_bn=True,norm_momentum=0.9, activation='swish'),
              num_classes=15,
...
train_data_input_path = './mydata/trainsrcdata/PICDIE/PICDIETrain_B91.tfrecord'
valid_data_input_path = './mydata/trainsrcdata/PICDIE/PICDIEVerify_B91.tfrecord'
model_dir = './mydata/trainmodels/PICDIE/trained_model_B91'
export_dir ='./mydata/trainmodels/PICDIE/exported_model_B91'
...
#TRAINER PART
train_steps = 2344*60
exp_config.trainer.steps_per_loop = 2344 # steps_per_loop = num_of_training_examples // train_batch_size

exp_config.trainer.summary_interval = 2344
exp_config.trainer.checkpoint_interval = 2344
exp_config.trainer.validation_interval = 2344
exp_config.trainer.validation_steps =  430 # validation_steps = num_of_validation_examples // eval_batch_size
exp_config.trainer.train_steps = train_steps
exp_config.trainer.optimizer_config.warmup.linear.warmup_steps = 2344*6


exp_config.trainer.optimizer_config.learning_rate.type = 'cosine'
exp_config.trainer.optimizer_config.learning_rate.cosine.decay_steps = train_steps
exp_config.trainer.optimizer_config.learning_rate.cosine.initial_learning_rate = 0.00008
...
#     params=exp_config,
#     checkpoint_path= './mydata/trainmodels/PICDIE/trained_model_B91_sys01_785/ckpt-140640',#tf.train.latest_checkpoint(model_dir) ,#(model_dir),
